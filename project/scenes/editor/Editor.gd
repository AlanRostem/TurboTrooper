...
onready var __tiles = $Tiles
onready var __entities = $Entities
onready var __tools = $Tools
onready var __tile_tween = $Tiles/TileTween
onready var __entities_tween = $Entities/EntitiesTween
onready var __tools_tween = $Tools/ToolsTween
