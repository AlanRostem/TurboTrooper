...
export var __let_player_kick_to_open = true

var __collectible
var __player_nearby

func _process(delta):
	if __let_player_kick_to_open and __player_nearby != null and !__player_nearby.stats.has_weapon() and  Input.is_action_just_pressed("fire"):
		destroy_self()
